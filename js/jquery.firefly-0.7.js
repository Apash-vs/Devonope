...
(function ($) {
    ...
    $.firefly.create = function (pixelSize) {
        ...
        return spark.css({
            ...
            'top': $.firefly.offsetTop + $.firefly.random(($.firefly.eleHeight - 5)), // Offset it to towards the bottom
            'left': $.firefly.offsetLeft + $.firefly.random(($.firefly.eleWidth - 5)), // Offset it to towards the right
